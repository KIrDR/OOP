...
namespace lab10
{
    ...
    public partial class Airlains
    {
        ...
        public Airlains(string Country, int Flight_Number, string Airplane_Type, DateTime Departure, string Day)
        {
            this.id = Airlains.NumOfFlights++;
        ...
        static Airlains() { Console.WriteLine("Вызвался статический конструктор\n"); }
        ~Airlains()
        {
            Airlains.NumOfFlights--;
        }
